...
% 无攻击的 NC 和 BER 值
[NC_no_attack, BER_no_attack] = sdwt_extract_TS(embedshp, '猫爪32.png');
...
for i = 1:13
    switch i
        ...
        case 4
            attackshp = attacks2_vertex_add(embedshp, outshpfile, c_values(4));
        case 5
            attackshp = attacks2_vertex_add(embedshp, outshpfile, c_values(5));
        case 6
            % noisestrength = 0.6
        ...
        case 10
            attackshp = attacks7_geometric(embedshp, outshpfile, 45, 0.5, 0, 0);
        case 11
...
% 保存为横向 Excel 文件
writetable(excel_data, 'attack_results_horizontal.xlsx', 'WriteVariableNames', false);
